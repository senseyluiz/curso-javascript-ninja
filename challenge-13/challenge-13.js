(function(){
	...
	*/
	var nordeste = ['Alagoas', 'Bahia', 'Ceará', 'Maranão', 'Paraíba', 'Pernambuco', 'Piauí', 'Rio Grande do Norte', 'Sergipe'];
	...
	*/
	...
	var resp = brasil.every(function(item){
